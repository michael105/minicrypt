...
void usage(){
 write(1,"usage: input | base32 [pos of linebreak]\n",sizeof("usage: input | base32 [pos of linebreak]\n"));
 exit(1);
}
int main(int argc, char **argv){
 char buf[4000 +8];
